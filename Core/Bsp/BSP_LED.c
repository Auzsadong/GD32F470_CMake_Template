...
/* ================== 通用底层驱动 (内部私有) ================== */
static void _Internal_LED_Init(uint32_t rcu, uint32_t port, uint32_t pin) {
...
/* ================== LED1 对象方法 ================== */
static void LED1_Init(void)   { _Internal_LED_Init(LED1_RCU, LED1_PORT, LED1_PIN); }
...
/* ================== LED2 对象方法 ================== */
static void LED2_Init(void)   { _Internal_LED_Init(LED2_RCU, LED2_PORT, LED2_PIN); }
...
/* ================== LED3 对象方法 ================== */
static void LED3_Init(void)   { _Internal_LED_Init(LED3_RCU, LED3_PORT, LED3_PIN); }
...
/* ================== LED4 对象方法 ================== */
static void LED4_Init(void)   { _Internal_LED_Init(LED4_RCU, LED4_PORT, LED4_PIN); }
...
/* ================== LED5 对象方法 ================== */
static void LED5_Init(void)   { _Internal_LED_Init(LED5_RCU, LED5_PORT, LED5_PIN); }
...
/* ================== LED6 对象方法 ================== */
static void LED6_Init(void)   { _Internal_LED_Init(LED6_RCU, LED6_PORT, LED6_PIN); }
